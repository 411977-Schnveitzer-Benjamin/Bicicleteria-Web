...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Bicicleta>(entity =>
        {
            ...
            entity.Property(e => e.PrecioPublico)
                .HasDefaultValue(0m)
                .HasColumnType("decimal(18, 2)");
            ...
            entity.Property(e => e.Velocidades)
                .HasMaxLength(20)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<Carrito>(entity =>
        {
            ...
            entity.HasOne(d => d.Bicicleta).WithMany(p => p.Carritos)
                .HasForeignKey(d => d.BicicletaId)
                .HasConstraintName("FK_Carrito_Bicis");

            entity.HasOne(d => d.Indumentaria).WithMany(p => p.Carritos)
                .HasForeignKey(d => d.IndumentariaId)
                .HasConstraintName("FK_Carrito_Ropa");

            entity.HasOne(d => d.Repuesto).WithMany(p => p.Carritos)
                .HasForeignKey(d => d.RepuestoId)
                .HasConstraintName("FK_Carrito_Repuestos");
        ...
        modelBuilder.Entity<DetalleVenta>(entity =>
        {
            ...
            entity.HasOne(d => d.Bicicleta).WithMany(p => p.DetalleVenta)
                .HasForeignKey(d => d.BicicletaId)
                .HasConstraintName("FK_Detalle_Bicis");

            entity.HasOne(d => d.Indumentaria).WithMany(p => p.DetalleVenta)
                .HasForeignKey(d => d.IndumentariaId)
                .HasConstraintName("FK_Detalle_Ropa");

            entity.HasOne(d => d.Repuesto).WithMany(p => p.DetalleVenta)
                .HasForeignKey(d => d.RepuestoId)
                .HasConstraintName("FK_Detalle_Repuestos");
        ...
        modelBuilder.Entity<Factura>(entity =>
        {
            ...
            entity.Property(e => e.VencimientoCae)
                .HasColumnType("datetime")
                .HasColumnName("VencimientoCAE");
            entity.Property(e => e.VentaId).HasColumnName("VentaID");

            entity.HasOne(d => d.TipoFactura).WithMany(p => p.Facturas)
                .HasForeignKey(d => d.TipoFacturaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Facturas_Tipos");

            entity.HasOne(d => d.Venta).WithOne(p => p.Factura)
                .HasForeignKey<Factura>(d => d.VentaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<ImagenesProducto>(entity =>
        {
            ...
            entity.HasOne(d => d.Bicicleta).WithMany(p => p.ImagenesProductos)
                .HasForeignKey(d => d.BicicletaId)
                .HasConstraintName("FK_Img_Bici");

            entity.HasOne(d => d.Indumentaria).WithMany(p => p.ImagenesProductos)
                .HasForeignKey(d => d.IndumentariaId)
                .HasConstraintName("FK_Img_Ind");

            entity.HasOne(d => d.Repuesto).WithMany(p => p.ImagenesProductos)
                .HasForeignKey(d => d.RepuestoId)
                .HasConstraintName("FK_Img_Rep");
        });
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.HasIndex(e => e.Dni, "UQ__Usuarios__C035B8DDEDFF29A8").IsUnique();
        ...
        modelBuilder.Entity<Venta>(entity =>
        {
            ...
            entity.HasOne(d => d.Estado).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK_Ventas_Estados");
