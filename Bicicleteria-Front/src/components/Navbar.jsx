...
import { DollarSign, ShoppingBag, Users, AlertTriangle, Package, TrendingUp, Activity } from 'lucide-react';
...
const Dashboard = () => {
  ...
  // Puerto HTTP 5028 (Asegúrate de que tu backend corre aquí)
  ...
  if (error) return (
    <div className="p-10 flex justify-center items-center min-h-screen bg-cairo-dark">
        <div className="glass-panel border border-red-500/30 text-red-200 px-8 py-6 rounded-2xl flex items-center shadow-[0_0_30px_rgba(220,38,38,0.2)]">
            <AlertTriangle className="mr-4 text-cairo-red" size={32}/>
  ...
  return (
    <div className="min-h-screen pt-28 pb-12 px-4 bg-cairo-dark relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* 1. TARJETAS DE MÉTRICAS (Magic UI Bento Grid Style) */}
