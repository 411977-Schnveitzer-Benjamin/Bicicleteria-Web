...
// --- 2. LAYOUT PÚBLICO (Con Navbar) ---
const LayoutPublico = () => {
  return (
    <>
      <Navbar />
      <div className="pt-24"> {/* Padding para que el contenido no quede tapado por la navbar fija */}
        <Outlet />
      </div>
      {/* Footer Simple */}
      <footer className="border-t border-white/10 py-8 text-center text-gray-500 text-sm mt-auto bg-cairo-dark">
...
// --- 3. COMPONENTE HOME (Tu diseño Magic UI intacto) ---
const Home = () => {
  return (
    <div className="pb-12 px-4 max-w-7xl mx-auto">
      
      {/* HERO SECTION */}
      <div className="flex flex-col items-center text-center mb-24 relative pt-10">
        ...
        >
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Link to="/contacto" className="px-8 py-3 rounded-full border border-white/20 hover:bg-white/5 font-bold text-white transition-colors">
              Contactar
            </Link>
          </div>
        </motion.div>
      ...
      >
        ...
        <div className="glass-panel rounded-3xl p-8 min-h-[300px] flex flex-col justify-between group hover:border-cairo-yellow/50 transition-colors">
          ...
          <div>
            <h3 className="text-3xl font-brand text-white">E-Bikes</h3>
        ...
        <div className="glass-panel rounded-3xl p-8 min-h-[250px] flex flex-col justify-between group hover:border-cairo-orange/50 transition-colors">
          ...
          <div>
            <h3 className="text-3xl font-brand text-white">Competición</h3>
        ...
        <div className="md:col-span-2 glass-panel rounded-3xl p-8 min-h-[250px] flex items-center justify-between group hover:border-cairo-red/50 transition-colors">
           <div>
             <h3 className="text-4xl font-brand text-white">Repuestos & Taller</h3>
...
function App() {
  return (
    <AuthProvider>
      <BrowserRouter>
        <div className="min-h-screen bg-cairo-dark text-white selection:bg-cairo-orange selection:text-white flex flex-col">
          <Routes>
            ...
            {/* RUTA DASHBOARD (Sin Navbar, pantalla completa) */}
            <Route 
              path="/dashboard" 
              element={
                <RutaProtegidaAdmin>
